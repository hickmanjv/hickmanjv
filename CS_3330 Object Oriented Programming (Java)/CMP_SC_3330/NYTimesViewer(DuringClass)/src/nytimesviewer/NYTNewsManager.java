...
public class NYTNewsManager {
    ...
    private final String apiKey = "f1613c260d744afd94e4c2182d9d11df";
    ...
    public void load(String searchString) throws Exception {
        ...
        try{
            ...
            encodedSearchString = URLEncoder.encode(searchString, "UTF-8");     // anything the user types, encode it so it plays nice
        ...
        try {
            BufferedReader in = new BufferedReader(new InputStreamReader(url.openStream())); // this grabs the content
