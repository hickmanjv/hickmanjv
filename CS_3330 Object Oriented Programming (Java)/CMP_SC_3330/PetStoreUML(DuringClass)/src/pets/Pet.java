...
public abstract class Pet {
    ...
    // need abstract keyword when making abstract methods in abstract class, in interface you don't need this
    // this isn't an interface so you have to make them public or otherwise
