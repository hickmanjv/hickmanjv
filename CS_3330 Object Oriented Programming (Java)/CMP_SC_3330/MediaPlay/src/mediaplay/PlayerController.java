...
public class PlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // song from hard drive
        //Media media = new Media(this.getClass().getResource("Sublime - Scarlet Begonias.mp3").toExternalForm());
        
        // video from hard drive
        //Media media = new Media(this.getClass().getResource("tomandjerry.mp4").toExternalForm());
        
        // song from server
        //Media media = new Media("http://www.professorwergeles.com/media/chiefs.mp3");
        
        // video from server
        Media media = new Media("http://www.professorwergeles.com/media/tomandjerry.mp4");
