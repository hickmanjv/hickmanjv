...
public class UserInterfaceController implements Initializable {
    ...
    private CounterRunnable thread1;
...
//        thread1 = new CounterThread(100000);
//        thread1.start();

          thread1 = new CounterRunnable(100000, textArea1);
         
          // to start a thread when implimenting Runnable you will always have to create a Thread object to call start()
    ...
    private void handleStart2(ActionEvent event) {
        ...
        thread2 = new CounterThread2(100000, textArea2);
        thread2.start();
    }
